...
class ModelConfig:
    ...
    model_type: Literal["causal_lm", "seq2seq", "vision", "text_classification"] = field(
        default="causal_lm",
        metadata={"help": "Model type: causal_lm, seq2seq, vision, or text_classification"},
    )
...
class DataConfig:
    ...
    eos_token: Optional[str] = field(
        default=None,
        metadata={"help": "Override EOS token passed through to TRL SFTConfig when supported"},
    )
