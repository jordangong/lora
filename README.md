...
The repository includes a standalone analysis script for measuring "intruder dimensions" from the paper `LoRA vs Full Fine-tuning: An Illusion of Equivalence` (`arXiv:2410.21228`).
...
The core implementation is available in [src/lora_finetune/intruder_dimensions.py](src/lora_finetune/intruder_dimensions.py).
